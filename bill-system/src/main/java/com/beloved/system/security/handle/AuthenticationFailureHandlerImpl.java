...
public class AuthenticationFailureHandlerImpl implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) throws IOException, ServletException {
        ...
        if (e instanceof MyAuthenticationException) {
            ...
            ServletUtils.writeJson(response, jsonUtils.toJSONString(new ResultVo<>(err.getCode(), e.getMessage())));
        } else {
            ServletUtils.writeJson(response, jsonUtils.toJSONString(new ResultVo<>(ErrorCode.AUTH_FAIL)));
        }
    }
